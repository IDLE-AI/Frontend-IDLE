...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-gradient-to-b from-transparent to-[#e879f9] md:px-10"
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-[#e879f9] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
