...
export default function Hero2() {
  return (
    <section className="grid grid-cols-2 relative mt-20 border-b border-[#d946ef]">
      <div>
        <div className="pl-20 py-28 2xl:pl-60 space-y-5">
          <div>
            <h1 className="text-8xl font-bold">IDLE</h1>
            <h2 className="text-[#d946ef] xl:text-xl 2xl:text-2xl">
        ...
        <div className="border-t border-[#c026d3] p-20  2xl:pl-60 py-28 space-y-5">
          <div className="grid grid-cols-2 items-center gap-10">
            <Button
              variant={"outline"}
              className="text-[#d946ef] border-[#d946ef] font-bold text-lg h-14"
              size={"lg"}
              asChild
            >
          ...
          <h2 className="text-2xl font-light">
            IDLE AI is pioneering the future of AI autonomy —{" "}
            <strong className="text-[#d946ef] capitalize font-bold">
              Create, trade, and own autonomous agents generating tokens
            </strong>{" "}
            seamless and{" "}
            <strong className="text-[#d946ef] capitalize font-bold">
              fee-free transaction experience
            </strong>
            , integrating state-of-the-art AI technology and blockchain to
            redefine token ecosystems.
          </h2>
        </div>
      </div>
      ...
      <div className="border-l border-[#d946ef] px-20 py-10 space-y-5">
        <Airdrop />
        {/* <h1 className='text-5xl text-[#d946ef] font-medium'>GET $IDLE PRESALE NOW!</h1>
